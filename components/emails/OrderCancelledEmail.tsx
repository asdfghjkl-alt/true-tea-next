  ...
  return (
    <Html>
      <Tailwind>
        ...
        <Preview>Order Cancelled - True Tea #{orderId.slice(-6)}</Preview>
          ...
          <Container className="email-wrapper border border-solid border-gray-200 rounded-lg max-w-[600px] mx-auto my-[40px] shadow-sm overflow-hidden">
            ...
            <Section className="bg-white p-6 pb-0 text-center">
              <Img
                ...
                className="mx-auto"
              />
              <Heading className="mt-4 text-xl font-bold text-red-600">
                Order Cancelled
              </Heading>
              <Text className="mt-2 text-sm text-gray-500">
                Hi {buyer.fname}, your order #{orderId.slice(-6)} has been
                cancelled.
              </Text>
            </Section>
            ...
            <Section className="bg-gray-50 border-t border-solid border-gray-100 p-6 text-sm">
              ...
              <Row>
                <Column>
                  <div className="inline-block px-2 py-1 rounded-full text-xs font-medium capitalize bg-red-100 text-red-700">
                    {status}
                  </div>
                </Column>
              </Row>
